...
var joinList = function() {
    ...
    if (errorMessage == "") {                // Discovered error here: The assignment operator was being used
        $("email_form").submit();            // where the comparison operator was needed.
    } else {
    	alert(errorMessage);
    }
};
...
window.onload = function() {
    $("join_list").onclick = joinList;  // Discovered error here: mistyped CSS id selector for 'join_list'
    $("email_address1").focus();
};
